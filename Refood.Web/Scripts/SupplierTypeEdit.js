...
Web.supplierTypeViewModel = function (moduleId, resx) {
    ...
    var getSupplierType = function (supplierTypeId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + supplierTypeId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
    ...
    var save = function () {
        ...
        if (supplierType.supplierTypeId > 0) {
            // ajaxMethod = "PATCH";
            restUrl += supplierType.supplierTypeId;
        }
        else {
            restUrl += 0;
        }
        ...
        var jqXHR = $.ajax({
            ...
            data: JSON.stringify(supplierType),
            dataType: "json"
        }).done(function (data) {
            console.log(data);
