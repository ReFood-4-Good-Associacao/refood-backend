...
Web.expenseViewModel = function (moduleId, resx) {
    ...
    var getExpense = function (expenseId) {
        ...
        var restUrl = baseUrl + "Get/" + expenseId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
    ...
    var load = function (data) {
        ...
        invoiceDate(serverDateTimeStringToJavascriptDate(data.invoiceDate));
        amount(data.amount);
    ...
    var save = function () {
        ...
        var expense = {
            ...
            partnerId: partnerId(),
            invoiceDate: dateToStringServerFormat(invoiceDate()),
            amount: amount(),
            isDeleted: isDeleted(),
        };
        var ajaxMethod = "POST";
