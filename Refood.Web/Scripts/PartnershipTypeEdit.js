...
Web.partnershipTypeViewModel = function (moduleId, resx) {
    ...
    var init = function () {
        ...
        var partnershipTypeId = qs["tid"];
        if (partnershipTypeId) {
            getPartnershipType(partnershipTypeId);
        }
        //getUserList();
    ...
    var getPartnershipType = function (partnershipTypeId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + partnershipTypeId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
    ...
    var save = function () {
        ...
        if (partnershipType.partnershipTypeId > 0) {
            // ajaxMethod = "PATCH";
            restUrl += partnershipType.partnershipTypeId;
        }
        else {
            restUrl += 0;
        }
        ...
        var jqXHR = $.ajax({
            ...
            data: JSON.stringify(partnershipType),
            dataType: "json"
        }).done(function (data) {
            console.log(data);
