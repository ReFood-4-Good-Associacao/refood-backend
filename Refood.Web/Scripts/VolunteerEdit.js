...
Web.volunteerViewModel = function (moduleId, resx) {
    ...
    var getVolunteer = function (volunteerId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + volunteerId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
    ...
    var load = function (data) {
        ...
        name(data.name);
        gender(data.gender);
        birthDate(serverDateTimeStringToJavascriptDate(data.birthDate));
    ...
    var save = function () {
        ...
        var volunteer = {
            ...
            name: name(),
            gender: gender(),
            birthDate: dateToStringServerFormat(birthDate()),
