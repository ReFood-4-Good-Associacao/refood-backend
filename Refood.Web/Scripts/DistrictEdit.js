...
Web.districtViewModel = function (moduleId, resx) {
    ...
    var getDistrict = function (districtId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + districtId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
