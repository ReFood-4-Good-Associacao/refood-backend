...
Web.taskTypeViewModel = function (moduleId, resx) {
    ...
    var getTaskType = function (taskTypeId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + taskTypeId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
