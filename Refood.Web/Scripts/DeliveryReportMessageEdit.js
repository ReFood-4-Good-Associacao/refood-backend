...
Web.deliveryReportMessageViewModel = function (moduleId, resx) {
    ...
    var init = function () {
        ...
        var deliveryReportMessageId = qs["tid"];
        if (deliveryReportMessageId) {
            getDeliveryReportMessage(deliveryReportMessageId);
        }
        //getUserList();
    ...
    var getDeliveryReportMessage = function (deliveryReportMessageId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + deliveryReportMessageId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
    ...
    var save = function () {
        ...
        if (deliveryReportMessage.deliveryReportMessageId > 0) {
            // ajaxMethod = "PATCH";
            restUrl += deliveryReportMessage.deliveryReportMessageId;
        }
        else {
            restUrl += 0;
        }
        ...
        var jqXHR = $.ajax({
            ...
            data: JSON.stringify(deliveryReportMessage),
            dataType: "json"
        }).done(function (data) {
            console.log(data);
