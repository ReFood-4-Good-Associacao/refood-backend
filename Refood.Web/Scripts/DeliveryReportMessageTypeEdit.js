...
Web.deliveryReportMessageTypeViewModel = function (moduleId, resx) {
    ...
    var init = function () {
        ...
        var deliveryReportMessageTypeId = qs["tid"];
        if (deliveryReportMessageTypeId) {
            getDeliveryReportMessageType(deliveryReportMessageTypeId);
        }
        //getUserList();
    ...
    var getDeliveryReportMessageType = function (deliveryReportMessageTypeId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + deliveryReportMessageTypeId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
    ...
    var save = function () {
        ...
        if (deliveryReportMessageType.deliveryReportMessageTypeId > 0) {
            // ajaxMethod = "PATCH";
            restUrl += deliveryReportMessageType.deliveryReportMessageTypeId;
        }
        else {
            restUrl += 0;
        }
        ...
        var jqXHR = $.ajax({
            ...
            data: JSON.stringify(deliveryReportMessageType),
            dataType: "json"
        }).done(function (data) {
            console.log(data);
