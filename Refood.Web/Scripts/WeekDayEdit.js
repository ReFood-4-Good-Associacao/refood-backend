...
Web.weekDayViewModel = function (moduleId, resx) {
    ...
    var getWeekDay = function (weekDayId) {
        isLoading(true);

        var restUrl = baseUrl + "Get/" + weekDayId;
        var jqXHR = $.ajax({
            url: restUrl,
            dataType: "json"
        }).done(function (data) {
